...
const ENEMY_STATS = {
  ...
  shooter:    { color: '#202837', hp: 3,  dmg: 2.5, bossBase: 190, name: 'Shooter' },
...
const WEAPON_ORDER = [
  'flamethrower', 'rpg', 'meteorCannon',
  'bubbleGun', 'pistol', 'shotgun',
  'smokeBomb', 'shadowPistol', 'chainHook',
  'crystalStaff', 'shardRifle', 'prismLance',
  'crossbow', 'galePistol', 'tempestBow',
  'quakeHammer', 'stoneCannon', 'drillLance',
  'teslaCoil', 'stormPistol', 'thunderShotgun'
];
const WEAPON_ITEMS = {
  flamethrower: {
    name: 'Flamethrower',
